...
const SelectOptions = () => {
    ...
    useEffect(() => {
        const t = setTimeout(() => {
            Object.entries(optionTextRefs.current).forEach(
                ([key, value], index) => {
                    setMaxOptionTextWidth((oldWidth) =>
                        value && value.scrollWidth > oldWidth
                            ? value.scrollWidth
                            : oldWidth
                    );
                }
        ...
        <div
            ...
            style={{
                ...
                minWidth: selectOptionsData.showSelectedParallel
                    ? `${
                          maxOptionTextWidth + 150 < 250
                              ? 250
                              : maxOptionTextWidth + 150
                      }px`
                    : "250px"
            }}
        >
            <div>
                {selectOptionsData.headerText ? (
                    <>
                        ...
                        <span
                            className={`select-options-headline-placeholder`}
                        />
                    </>
                ) : null}
                        ...
                        <>
                            ...
                            selectOptionsData.multiSelect ? (
                                <Button
                                    ...
                                    blue
                                >
                                    {selectOptionsData.closeButtonText ??
                                        "done"}
                                </Button>
                            ) : null}
                        </>
                    ...
                    {(selectOptionsData.showSelectedParallel
                        ...
                        return index !== 2 ? (
                            <div key={index} className={`content ${index}-ct`}>
                                ...
                                {selectOptionsData.defaultOption &&
                                index === 1 ? (
                                    <SelectOption
                                        options={selectOptionsData.options}
                                        id={""}
                                        disableSelecting={
                                            selectOptionsData.disableSelecting
                                        }
                                        setDisableSelecting={
                                        ...
                                        setShowOptions={
                                            selectOptionsData.setShowOptions
                                        }
                                        setSelectedOption={
                                            selectOptionsData.setSelectedOption
                                        }
                                        ...
                                        defaultOption
                                    >
                                        {selectOptionsData.defaultOptionText ??
                                            "Select a option"}
                                    </SelectOption>
                                ) : null}
                                <div>
                                    {(() => {
                                        ...
                                        try {
                                            const DescSorted = _.sortBy(
                                                optionsListNotSorted,
                                                (o) => o[1]?.toUpperCase()
                                            );
