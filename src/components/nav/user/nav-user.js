...
const NavUser = (props) => {
    return (
        <div className={`tv-tool-user  ${props.open ? "open" : ""}`}>
            <div
                className={`tv-tool-user-image`}
                style={{ backgroundImage: `url(${ProfileImage})` }}
            />
            <div className={"tv-tool-user-name"}>
                {props.userName
                    ? props.userName.split(".").map((nameTile, index) => {
                          ...
                          return [
                              <div
                                  ...
                                  ref={(el) =>
                                      (nameRef.current[keys.openNameTile] = el)
                                  }
                                  className={`tv-tool-user-name-tile`}
                                  style={{
                                      fontSize: "20px",
                                      opacity: 0,
                                      position: "absolute"
